...
const CompanyProfile = () => {
  return (
    <div className="mx-3 mt-10 container mx-auto">
      ...
      <div className="w-96 float-right mt-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
        <DonutChart />
        <DonutChart />
      </div>
